                        ...
                        <div class="card-header" style="height:50px;">
                            <div class="card-title layout_btns" id="basic-layout-form">
                                ...
                                <div class="btns-right-side">
                                    <a href="{{ route('products.create') }}" method="post"
                                        class="btn mr-1 mb-1 btn-success btn-sm" type="submit">Add </a>
                                    <a href="{{ route('product-attributes.import') }}" method="post"
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form class="form" action="{{ route('products.multipledelete') }}" method="post"
                                        id="{{ 'delete_all' }}">
                                        @csrf
                                        <table class="table table-striped table-bordered zero-configuration"
                                            style="width:100%; display:table;" id="product">
                                            <thead>
                                                <tr>
