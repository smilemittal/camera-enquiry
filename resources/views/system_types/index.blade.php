                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form class="form" action="{{ route('system-types.multipledelete') }}" method="post"
                                        id="{{ 'delete_all' }}">
                                        @csrf
                                        <table class="table table-striped table-bordered zero-configuration"
                                            id="system_types" style="width: 100%; display: table;">
                                            <thead>
                                                <tr>
        ...
        $(document).ready(function() {
            ...
            $('#system_types').DataTable({
                ...
                "ajax": {
                    ...
                    "data": {
                        _token: "{{ csrf_token() }}",
                        route: '{{ route('system-types.index') }}'
                    }
                },
                "columns": [{
                        "data": "#"
