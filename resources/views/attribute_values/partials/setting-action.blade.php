...
<a class="dropdown-item edit" href="{{ route('attribute-values.edit', $attribute_value?? ''->id)}}"><i
class="fa fa-edit"></i>Edit</a>
<form action="{{ route('attribute-values.destroy', [$attribute_value->id]) }}" method="post" id="{{ 'delete_form_'.$attribute_value->id}}">
@csrf
@method('DELETE')
</form>
<a href="#"onclick="document.getElementById('{{ 'delete_form_'.$attribute_value->id }}').submit();" class="dropdown-item delete" >Delete</a>
</span>
</span>