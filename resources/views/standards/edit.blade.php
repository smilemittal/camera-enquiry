 ...
 @section('content')
     ...
     <div class="content-header row">
         <div class="content-header-left col-md-4 col-12 mb-2">
             <h3 class="content-header-title">{{ translate('Standard') }}</h3>
         </div>
                 ...
                 <div class="breadcrumb-wrapper mr-1">
                     <ol class="breadcrumb">
                         ...
                         <li class="breadcrumb-item"><a
                                 href="{{ route('standards.index') }}">{{ translate('List') }}</a>
                         </li>
                 ...
                 <div class="col-md-8">
                     <div class="card">
                         <div class="card-header">
                             <h4 class="card-title" id="basic-layout-form">{{ translate('Edit Standard') }}</h4>
                             ...
                             <div class="card-body">
                                 ...
                                 <form method="Post" action="{{ route('standards.update', $standard->id) }}">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <select name="system_type_id" id="system_type_id" class="form-control">
                                                 ...
                                                 @foreach ($system_types as $system_type)
                                                     <option value="{{ $system_type->id }}" @if ($standard->system_type_id == $system_type->id) selected @endif>{{ $system_type->name }}
                                                     </option>
                                                 @endforeach
                                             </select>
                                         </div>
                                     ...
                                     <div class="form-actions" style="text-align: center;">
                                         <button type="Reset" class="btn btn-danger">{{ translate('Reset') }}
                                         </button>
