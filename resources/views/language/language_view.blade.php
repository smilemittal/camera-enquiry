                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <form class="form" action="{{ route('languages.key_value_store', $language->id) }}" method="post" id="{{ 'delete_all' }}">
                                            @csrf 
                                    ...
                                    <div class="form-actions" style="text-align: center;">
                                        <button type="submit" name="update" value="submit" class="btn mr-1 mb-1 btn-success btn-sm">Submit</button>
        ...
        $(document).ready(function(){
            ...
            $('#languages_view').DataTable({
                ...
                "ajax":{
                    ...
                    "dataType": "json",
                    "type": "POST",
                    "data":{ _token: "{{csrf_token()}}",route:'{{route('languages.key_value_store', $language->id)}}'}
                },
                "columns": [
                    { "data": "#" },
                    { "data": "id" },
