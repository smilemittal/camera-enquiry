                                    ...
                                    <div class="form-body">
                                            ...
                                            <select name="type_id" id="type_id" class="form-control">
                                                @foreach ($types ?? '' as $type)
                                                    <option value="{{ $type->id }}"
                                                        {{ $attribute->type_id == $type->id ? 'selected' : '' }}>
                                                        {{ $type->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <select name="system_type_id" id="system_type_id" class="form-control">
                                                @foreach ($system_types ?? '' as $system_type)
                                                    <option value="{{ $system_type->id }}"
                                                        {{ $attribute->system_type_id == $system_type->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="display_order" class="form-control"
                                                value="{{ $attribute->display_order }}" name="display_order">
                                        </div>
                                        <div class="form-group">
                                            <label for="Description">{{ translate('Description') }}</label>
                                            <textarea rows="5" class="form-control"
                                                name="description"><?php echo htmlspecialchars($attribute->description); ?></textarea>
                                        </div>
