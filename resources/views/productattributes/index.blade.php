            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">{{__('site.product_attributes')}}</h4>
        ...
        $(document).ready(function(){
            ...
            $('#productAttributes').DataTable({
                ...
                "ajax":{
                    ...
                    "dataType": "json",
                    "type": "POST",
                    "data":{ _token: "{{csrf_token()}}",route:'{{route('product-attributes.index')}}'}
                },
                "columns": [
                    { "data": "id" },
                    { "data": "product_id" },
