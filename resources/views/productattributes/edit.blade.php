                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{ __('site.edit_product_attributes')}}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{ route('product-attributes.update',$id) }}" method="post">
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label for="name">{{__('site.attribute_value')}}</label>
                                            ...
                                            <div class="form-actions" style="text-align: center;">
                                                ...
                                                <button type="submit" class="btn btn-success">{{__('site.view_all')}}
                                                </button>
                                            </div>
                                          </form>
                                    </div>
