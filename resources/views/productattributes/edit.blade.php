                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('product-attributes.update', $id) }}" method="post">
                                        ...
                                        <select name="product_id" id="product_id" class="form-control">
                                            @foreach ($products as $product)
                                                <option value="{{ $product->id }}"
                                                    {{ $product->id == $product_attributes->product_id ? 'selected' : '' }}>
                                                    {{ $product->name }}</option>
                                        ...
                                        <select name="attribute_id" id="attribute_id" class="form-control">
                                            @foreach ($attributes as $attribute)
                                                <option value="{{ $attribute->id }}"
                                                    {{ $attribute->id == $product_attributes->attribute_id ? 'selected' : '' }}>
                                            ...
                                            <select name="attribute_value_id" id="attribute_value_id" class="form-control">
                                                @foreach ($attributevalues as $attributevalue)
                                                    ...
                                                    <option value="{{ $attributevalue->id }}"
                                                        {{ $attributevalue->id == $product_attributes->attribute_value_id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-actions" style="text-align: center;">
                                        <a href="{{ route('product-attributes.index') }}" method="post"
                                            class="btn btn-primary" type="submit">{{ translate('View all') }}</a>
