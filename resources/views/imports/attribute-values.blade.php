...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">{{ translate('Attribute') }}</h3>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                @endif
                                <form class="form" action="{{ route('attribute.post-import') }}" method="post"
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" placeholder="Value"
                                                name="import-attribute-values">
                                            <label for="Example">{{ translate('Example') }}</label>
                                            <a href={{ asset('assets/frontend/example/attribute.xlsx') }}
