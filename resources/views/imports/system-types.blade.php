                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{ __('site.import_system_types')}}</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{ route('system-types.post-import') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-actions" style="text-align: center;">
                                                <a href="{{ route('system-types.index')}}" method="post" class="btn btn-primary" type="submit">{{__('site.view_all')}}</a>    
