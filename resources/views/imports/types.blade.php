                            ...
                            <!-- Card content body start -->
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form class="form" action="{{ route('types.post-import') }}" method="post" enctype="multipart/form-data">
                                            @csrf  
                                            <div class="form-body">
                                                <div  class="form-group">
                                                    <label for="File">{{translate('File')}}</label>
                                                    <input type="file" class="form-control" placeholder="Value" name="import-types">
                                                    <label for="Example">{{translate('Example')}}</label>
                                                    <a href={{asset('assets/frontend/example/types.xlsx')}} style="color:#464855;" download><i > </i> {{translate('Download')}}  </a>
                                                </div>
                                            </div>
