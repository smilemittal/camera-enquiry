                            ...
                            <!-- Card content body start -->
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form class="form" action="{{ route('standards.post-import') }}" method="post" enctype="multipart/form-data">
                                            @csrf  
                                            <div class="form-body">
                                                <div  class="form-group">
                                                    ...
                                                    <a href={{asset('assets/frontend/example/standard.xlsx')}} style="color:#464855;"download><i > </i>{{translate('Download')}}</a>
                                                </div>
                                            </div>
