                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exchange_rate">{{translate('Exchange Rate')}}</label>
                                                ...
                                                <input type="number" step="0.01" min="0" placeholder="{{translate('Exchange Rate')}}" id="exchange_rate" name="exchange_rate" class="form-control" step="any" required>
                                            ...
                                            <label for="status">{{translate('Status')}}</label>
                                                ...
                                                <select id="status" name="status" class="form-control">
                                                    @foreach(\App\Models\Currency::STATUS as $status_id => $value)
                                                        <option value="{{ $status_id }}">{{ translate($value) }}</option>
                                                    @endforeach
                                                </select>
